...
export async function guardarBusqueda(formData: FormData) {
  ...
  const data = {
    ...
    beneficios: val(formData, "beneficios"),
    jornada_laboral: nullable(formData, "jornada_laboral"),
    convenio: nullable(formData, "convenio"),
    descansos: nullable(formData, "descansos"),
